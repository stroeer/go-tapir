...
type Article_Part_Type int32

const (
	// Not specified.
	Article_Part_CONTENT_TYPE_UNSPECIFIED Article_Part_Type = 0
	// The article body incl. all inline elements.
	Article_Part_BODY Article_Part_Type = 1
	// A wrapper for all article sources ("Quellenaparat"). There can only be one of these per article.
	Article_Part_ARTICLE_SOURCES Article_Part_Type = 2
	// A article disclaimer with important notes/legal stuff. E.g. "medizinischer Hinweis" on all medical articles
	Article_Part_DISCLAIMER Article_Part_Type = 3
	// Includes information what the current article type is (e.g. opinion article). There can only be one of these per article.
	Article_Part_TRUST_BOX Article_Part_Type = 4
)

// Enum value maps for Article_Part_Type.
var (
	Article_Part_Type_name = map[int32]string{
	...
	Article_Part_Type_value = map[string]int32{
		"CONTENT_TYPE_UNSPECIFIED": 0,
		"BODY":                     1,
		"ARTICLE_SOURCES":          2,
		"DISCLAIMER":               3,
...
func (x Article_Part_Type) Enum() *Article_Part_Type {
	p := new(Article_Part_Type)
	*p = x
	return p
}

func (x Article_Part_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Article_Part_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_stroeer_core_v1_article_proto_enumTypes[5].Descriptor()
}

func (Article_Part_Type) Type() protoreflect.EnumType {
	return &file_stroeer_core_v1_article_proto_enumTypes[5]
}

func (x Article_Part_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Article_Part_Type.Descriptor instead.
func (Article_Part_Type) EnumDescriptor() ([]byte, []int) {
...
type Article struct {
	...
	Parts []*Article_Part `protobuf:"bytes,6,rep,name=parts,proto3" json:"parts,omitempty"`
	//*
	// ## `metadata`
	// ```protobuf
	// Metadata metadata = 7;
...
func (x *Article) GetParts() []*Article_Part {
	if x != nil {
		return x.Parts
	}
	return nil
...
type Article_Part struct {
	...
	Items []*Article_Part_Item `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	Type  Article_Part_Type    `protobuf:"varint,2,opt,name=type,proto3,enum=stroeer.core.v1.Article_Part_Type" json:"type,omitempty"`
}

func (x *Article_Part) Reset() {
	*x = Article_Part{}
	if protoimpl.UnsafeEnabled {
...
func (x *Article_Part) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Article_Part) ProtoMessage() {}

func (x *Article_Part) ProtoReflect() protoreflect.Message {
	mi := &file_stroeer_core_v1_article_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Article_Part.ProtoReflect.Descriptor instead.
func (*Article_Part) Descriptor() ([]byte, []int) {
	return file_stroeer_core_v1_article_proto_rawDescGZIP(), []int{0, 2}
}

func (x *Article_Part) GetItems() []*Article_Part_Item {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *Article_Part) GetType() Article_Part_Type {
	if x != nil {
		return x.Type
	}
	return Article_Part_CONTENT_TYPE_UNSPECIFIED
}
...
type Article_Part_Item struct {
	...
	Items []*Article_Part_Item `protobuf:"bytes,4,rep,name=items,proto3" json:"items,omitempty"`
	//*
	// ## `elements`
	// ```protobuf
...
func (x *Article_Part_Item) Reset() {
	*x = Article_Part_Item{}
	if protoimpl.UnsafeEnabled {
...
func (x *Article_Part_Item) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Article_Part_Item) ProtoMessage() {}

func (x *Article_Part_Item) ProtoReflect() protoreflect.Message {
	mi := &file_stroeer_core_v1_article_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Article_Part_Item.ProtoReflect.Descriptor instead.
func (*Article_Part_Item) Descriptor() ([]byte, []int) {
	return file_stroeer_core_v1_article_proto_rawDescGZIP(), []int{0, 2, 0}
}

func (x *Article_Part_Item) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *Article_Part_Item) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *Article_Part_Item) GetFields() map[string]string {
	if x != nil {
		return x.Fields
	}
	return nil
...
func (x *Article_Part_Item) GetItems() []*Article_Part_Item {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *Article_Part_Item) GetElements() []*Article_Element {
	if x != nil {
		return x.Elements
	}
	return nil
...
var file_stroeer_core_v1_article_proto_rawDesc = []byte{
	...
	0xb2, 0x16, 0x0a, 0x07, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	,
	...
	,
	...
	0x74, 0x52, 0x08, 0x63, 0x68, 0x69, 0x6c, 0x64, 0x72, 0x65, 0x6e, 0x1a, 0xe4, 0x02, 0x0a, 0x05,
	...
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x54, 0x0a, 0x04,
	...
	0x10, 0x04, 0x22, 0x95, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x54,
	0x59, 0x50, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10,
	0x00, 0x12, 0x0b, 0x0a, 0x07, 0x41, 0x52, 0x54, 0x49, 0x43, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x09,
	...
	0x04, 0x12, 0x0a, 0x0a, 0x06, 0x4f, 0x45, 0x4d, 0x42, 0x45, 0x44, 0x10, 0x05, 0x12, 0x0a, 0x0a,
	0x06, 0x41, 0x55, 0x54, 0x48, 0x4f, 0x52, 0x10, 0x06, 0x12, 0x0a, 0x0a, 0x06, 0x41, 0x47, 0x45,
	0x4e, 0x43, 0x59, 0x10, 0x07, 0x12, 0x15, 0x0a, 0x11, 0x45, 0x44, 0x47, 0x45, 0x5f, 0x53, 0x49,
	0x44, 0x45, 0x5f, 0x49, 0x4e, 0x43, 0x4c, 0x55, 0x44, 0x45, 0x10, 0x08, 0x12, 0x0c, 0x0a, 0x08,
	0x43, 0x49, 0x54, 0x41, 0x54, 0x49, 0x4f, 0x4e, 0x10, 0x09, 0x22, 0x3c, 0x0a, 0x08, 0x52, 0x65,
	...
	,
	...
	0x62, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1c, 0x0a, 0x18, 0x43, 0x4f, 0x4e, 0x54, 0x45,
	0x4e, 0x54, 0x5f, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46,
	0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x08, 0x0a, 0x04, 0x42, 0x4f, 0x44, 0x59, 0x10, 0x01, 0x12,
	0x13, 0x0a, 0x0f, 0x41, 0x52, 0x54, 0x49, 0x43, 0x4c, 0x45, 0x5f, 0x53, 0x4f, 0x55, 0x52, 0x43,
	0x45, 0x53, 0x10, 0x02, 0x12, 0x0e, 0x0a, 0x0a, 0x44, 0x49, 0x53, 0x43, 0x4c, 0x41, 0x49, 0x4d,
	0x45, 0x52, 0x10, 0x03, 0x12, 0x0d, 0x0a, 0x09, 0x54, 0x52, 0x55, 0x53, 0x54, 0x5f, 0x42, 0x4f,
	0x58, 0x10, 0x04, 0x1a, 0x80, 0x04, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	...
	0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22,
	...
	0x52, 0x41, 0x46, 0x54, 0x10, 0x03, 0x1a, 0x33, 0x0a, 0x07, 0x4b, 0x65, 0x79, 0x77, 0x6f, 0x72,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x04,
	0x54, 0x79, 0x70, 0x65, 0x12, 0x14, 0x0a, 0x10, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x55, 0x4e, 0x53,
	...
	0x4c, 0x10, 0x08, 0x22, 0xae, 0x01, 0x0a, 0x07, 0x53, 0x75, 0x62, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x41, 0x4c, 0x10, 0x09, 0x42, 0x40, 0x0a, 0x12, 0x64, 0x65, 0x2e, 0x73, 0x74, 0x72, 0x6f, 0x65,
	0x65, 0x72, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a, 0x28, 0x67, 0x69,
...
var file_stroeer_core_v1_article_proto_goTypes = []interface{}{
	...
	(Article_Part_Type)(0),          // 5: stroeer.core.v1.Article.Part.Type
	...
	(*Article_Part)(nil),            // 10: stroeer.core.v1.Article.Part
	...
	(*Article_Part_Item)(nil),       // 15: stroeer.core.v1.Article.Part.Item
	nil,                             // 16: stroeer.core.v1.Article.Part.Item.FieldsEntry
...
var file_stroeer_core_v1_article_proto_depIdxs = []int32{
	...
	10, // 4: stroeer.core.v1.Article.parts:type_name -> stroeer.core.v1.Article.Part
	...
	15, // 12: stroeer.core.v1.Article.Part.items:type_name -> stroeer.core.v1.Article.Part.Item
	5,  // 13: stroeer.core.v1.Article.Part.type:type_name -> stroeer.core.v1.Article.Part.Type
	...
	16, // 23: stroeer.core.v1.Article.Part.Item.fields:type_name -> stroeer.core.v1.Article.Part.Item.FieldsEntry
	15, // 24: stroeer.core.v1.Article.Part.Item.items:type_name -> stroeer.core.v1.Article.Part.Item
	9,  // 25: stroeer.core.v1.Article.Part.Item.elements:type_name -> stroeer.core.v1.Article.Element
...
func file_stroeer_core_v1_article_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stroeer_core_v1_article_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Article_Part_Item); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
