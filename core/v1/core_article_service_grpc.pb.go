...
const (
	ArticleService_GetArticle_FullMethodName       = "/stroeer.core.v1.ArticleService/GetArticle"
	ArticleService_BatchGetArticles_FullMethodName = "/stroeer.core.v1.ArticleService/BatchGetArticles"
	ArticleService_ListArticles_FullMethodName     = "/stroeer.core.v1.ArticleService/ListArticles"
	ArticleService_ListSections_FullMethodName     = "/stroeer.core.v1.ArticleService/ListSections"
)
...
func (c *articleServiceClient) BatchGetArticles(ctx context.Context, in *BatchGetArticlesRequest, opts ...grpc.CallOption) (*BatchGetArticlesResponse, error) {
	...
	err := c.cc.Invoke(ctx, ArticleService_BatchGetArticles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *articleServiceClient) ListSections(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListSectionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, ArticleService_ListSections_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ArticleService_BatchGetArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArticleService_BatchGetArticles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ArticleService_ListSections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ArticleService_ListSections_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
