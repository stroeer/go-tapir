...
func (c *stageServiceClient) GetStages(ctx context.Context, in *GetStagesRequest, opts ...grpc.CallOption) (*GetStagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, StageService_GetStages_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stageServiceClient) GetArticleCompanions(ctx context.Context, in *GetArticleCompanionsRequest, opts ...grpc.CallOption) (*GetArticleCompanionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, StageService_GetArticleCompanions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _StageService_GetStages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StageService_GetStages_FullMethodName,
	}
...
func _StageService_GetArticleCompanions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StageService_GetArticleCompanions_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
